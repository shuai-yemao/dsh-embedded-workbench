...
export class WorkbenchCapabilitiesGateway extends TypertRemoteService {
    // Cordis invokes Service methods through a Proxy receiver. A JavaScript
    // private field would reject that receiver, so keep this implementation
    // detail TypeScript-private while retaining proxy-compatible property access.
    private readonly controller: CapabilityGatewayController;
